...
>
    <div class="flex in-[.group\/center-align]:justify-center in-[group\/end-align]:justify-end">
        ...
        @if(!$sortable)
            {{ $slot }}
        @else
            <button type="button" class="group/sortable flex items-center gap-1 -my-1 -ms-2 -me-2 px-2 py-1  in-[.group\/end-align]:flex-row-reverse in-[.group\/end-align]:-me-2 in-[.group\/end-align]:-ms-8">
                <div>{{ $slot }}</div>
